{{-- sidebar:
views.dashboard.sidebar.blade.php --}}
@php
$side_links = [
    [
        'name' => 'Users',
    ...
    [
        'name' => ' Roles ',
        'route' => route('gato'),
        'active' => false, //request()->routeIs('banca.*'),
        'disabled' => false,
    ],
    [
        'name' => ' Permissions ',
        'route' => route('gato'),
        'active' => false, //request()->routeIs('acercade'),
        'disabled' => false,
    ],
    [
        'name' => ' Categorias ',
...
<aside class="flex-initial w-32" aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        Dashboard
        <ul class="space-y-2">
            @foreach ($side_links as $side_link)
                <li>
                    @if (!$side_link['disabled'])
                        <x-jet-nav-link href="{{ $side_link['route'] }}" :active="$side_link['active']"
                            class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            <span class="ml-3">{{ __($side_link['name']) }}</span>
                        </x-jet-nav-link>
                    @endif
